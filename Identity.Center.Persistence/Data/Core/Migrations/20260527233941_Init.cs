        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    mfa_signature = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    created_at_utc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, defaultValueSql: "getutcdate()"),
                    created_by = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValue: new Guid("00000000-0000-0000-0000-000000000000")),
                    last_modified_at_utc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    last_modified_by = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    key = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    path = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValue: "/"),
                    exclude_navigation = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    index = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    icon = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    parent_route_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    created_at_utc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, defaultValueSql: "getutcdate()"),
                    created_by = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValue: new Guid("00000000-0000-0000-0000-000000000000")),
                    last_modified_at_utc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    last_modified_by = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_routes_apps_app_id",
                        column: x => x.app_id,
                        principalSchema: "build",
                        principalTable: "apps",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_routes_routes_parent_route_id",
                        column: x => x.parent_route_id,
                        principalSchema: "build",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_routes_claims", x => new { x.route_id, x.claim_id });
                    table.ForeignKey(
                        name: "FK_routes_claims_claims_claim_id",
                        column: x => x.claim_id,
                        principalSchema: "auth",
                        principalTable: "claims",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_routes_claims_routes_route_id",
                        column: x => x.route_id,
                        principalSchema: "build",
                        principalTable: "routes",
                        principalColumn: "id");
            ...
            migrationBuilder.InsertData(
                schema: "sec",
                table: "actions",
                columns: new[] { "id", "deleted_at_utc", "deleted_by", "description", "last_modified_at_utc", "last_modified_by", "name" },
                values: new object[,]
                {
                    { new Guid("6343da36-3343-f111-81e9-00505682eca9"), null, null, "Descargar", null, null, "download" },
                    { new Guid("6443da36-3343-f111-81e9-00505682eca9"), null, null, "Crear", null, null, "create" },
                    { new Guid("6543da36-3343-f111-81e9-00505682eca9"), null, null, "Ver", null, null, "view" },
                    { new Guid("6643da36-3343-f111-81e9-00505682eca9"), null, null, "Modificar/Actualizar", null, null, "update" },
                    { new Guid("6743da36-3343-f111-81e9-00505682eca9"), null, null, "Cargar", null, null, "upload" },
                    { new Guid("6843da36-3343-f111-81e9-00505682eca9"), null, null, "Eliminar", null, null, "delete" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("16842a5f-3943-f111-81e9-00505682eca9"), null, null, "Usuarios", null, null, "users" },
                    { new Guid("17842a5f-3943-f111-81e9-00505682eca9"), null, null, "Grupos", null, null, "groups" },
                    { new Guid("18842a5f-3943-f111-81e9-00505682eca9"), null, null, "HealtChecks", null, null, "healtchecks" },
                    { new Guid("19842a5f-3943-f111-81e9-00505682eca9"), null, null, "Aplicaciones", null, null, "apps" },
                    { new Guid("1a842a5f-3943-f111-81e9-00505682eca9"), null, null, "Tipos de contacto", null, null, "contacttypes" },
                    { new Guid("1b842a5f-3943-f111-81e9-00505682eca9"), null, null, "Configuraciones", null, null, "settings" },
                    { new Guid("1c842a5f-3943-f111-81e9-00505682eca9"), null, null, "Permisos", null, null, "claims" },
                    { new Guid("1d842a5f-3943-f111-81e9-00505682eca9"), null, null, "Acciones", null, null, "actions" },
                    { new Guid("1e842a5f-3943-f111-81e9-00505682eca9"), null, null, "Tipos de credenciales", null, null, "credentialtypes" },
                    { new Guid("9daff3d6-ba48-f111-81e9-00505682eca9"), null, null, "Api keys", null, null, "apikeys" },
                    { new Guid("c93e61d8-9949-f111-81e9-00505682eca9"), null, null, "Credenciales de usuario", null, null, "credentials" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5f9c0e66-e29f-f011-81de-00505682eca9"), "ContactTypesOptions:CellPhoneExpressions:0", null, null, null, null, "^\\+573\\d{9}$" },
                    { new Guid("5f9c0e66-e29f-f011-81de-00505682eca9"), "ContactTypesOptions:EmailExpressions:1", null, null, null, null, "^([a-z]+\\.[a-z]+@finanzauto\\.com\\.co)$" },
                    { new Guid("5f9c0e66-e29f-f011-81de-00505682eca9"), "ContactTypesOptions:EmailExpressions:2", null, null, null, null, "^([a-z]+\\.[a-z]+@promotec\\.com)$" },
                    { new Guid("5f9c0e66-e29f-f011-81de-00505682eca9"), "ContactTypesOptions:EmailExpressions:3", null, null, null, null, "^([a-z]+\\.[a-z]+@asisya\\.com)$" },
                    { new Guid("5f9c0e66-e29f-f011-81de-00505682eca9"), "ContactTypesOptions:EmailExpressions:4", null, null, null, null, "^([a-z]+\\.[a-z]+@carfiao\\.com)$" },
                    ...
                    { new Guid("5f9c0e66-e29f-f011-81de-00505682eca9"), "QdControlOptions:BaseUrl", null, null, null, null, "http://www.qdatacolombia.com/Services/ServiciosApi/ServiceAutenticacionLDAP" },
            ...
            migrationBuilder.InsertData(
                schema: "auth",
                table: "claims",
                columns: new[] { "id", "action_id", "deleted_at_utc", "deleted_by", "group_id", "last_modified_at_utc", "last_modified_by" },
                values: new object[,]
                {
                    { new Guid("2950cf98-0e44-f111-81e9-00505682eca9"), new Guid("6443da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1d842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("2a50cf98-0e44-f111-81e9-00505682eca9"), new Guid("6843da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1d842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("2b50cf98-0e44-f111-81e9-00505682eca9"), new Guid("6643da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1d842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("2c50cf98-0e44-f111-81e9-00505682eca9"), new Guid("6543da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1d842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("2d50cf98-0e44-f111-81e9-00505682eca9"), new Guid("6443da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("19842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("2e50cf98-0e44-f111-81e9-00505682eca9"), new Guid("6843da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("19842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("2f50cf98-0e44-f111-81e9-00505682eca9"), new Guid("6743da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("19842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("3050cf98-0e44-f111-81e9-00505682eca9"), new Guid("6543da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("19842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("51e4990e-9a49-f111-81e9-00505682eca9"), new Guid("6543da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("c93e61d8-9949-f111-81e9-00505682eca9"), null, null },
                    { new Guid("52e4990e-9a49-f111-81e9-00505682eca9"), new Guid("6443da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("c93e61d8-9949-f111-81e9-00505682eca9"), null, null },
                    { new Guid("54e4990e-9a49-f111-81e9-00505682eca9"), new Guid("6643da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("c93e61d8-9949-f111-81e9-00505682eca9"), null, null },
                    { new Guid("57e4990e-9a49-f111-81e9-00505682eca9"), new Guid("6843da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("c93e61d8-9949-f111-81e9-00505682eca9"), null, null },
                    { new Guid("66ca6fe3-ba48-f111-81e9-00505682eca9"), new Guid("6543da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("9daff3d6-ba48-f111-81e9-00505682eca9"), null, null },
                    { new Guid("67ca6fe3-ba48-f111-81e9-00505682eca9"), new Guid("6443da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("9daff3d6-ba48-f111-81e9-00505682eca9"), null, null },
                    { new Guid("68ca6fe3-ba48-f111-81e9-00505682eca9"), new Guid("6643da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("9daff3d6-ba48-f111-81e9-00505682eca9"), null, null },
                    { new Guid("69ca6fe3-ba48-f111-81e9-00505682eca9"), new Guid("6843da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("9daff3d6-ba48-f111-81e9-00505682eca9"), null, null },
                    { new Guid("a554cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6443da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1c842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("a654cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6843da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1c842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("a754cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6643da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1c842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("a854cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6543da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1c842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("a954cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6543da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1a842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("aa54cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6443da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1e842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("ab54cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6843da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1e842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("ac54cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6643da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1e842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("ad54cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6543da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1e842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("ae54cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6443da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("17842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("af54cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6843da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("17842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("b054cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6643da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("17842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("b154cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6543da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("17842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("b254cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6443da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("18842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("b354cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6843da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("18842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("b454cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6643da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("18842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("b554cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6543da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("18842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("b654cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6443da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1b842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("b754cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6843da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1b842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("b854cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6643da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1b842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("b954cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6543da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("1b842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("ba54cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6443da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("16842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("bb54cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6843da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("16842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("bc54cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6643da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("16842a5f-3943-f111-81e9-00505682eca9"), null, null },
                    { new Guid("bd54cc9e-0e44-f111-81e9-00505682eca9"), new Guid("6543da36-3343-f111-81e9-00505682eca9"), null, null, new Guid("16842a5f-3943-f111-81e9-00505682eca9"), null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_routes_app_id_key_path",
                schema: "build",
                table: "routes",
                columns: new[] { "app_id", "key", "path" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_routes_parent_route_id",
                schema: "build",
                table: "routes",
                column: "parent_route_id");

            migrationBuilder.CreateIndex(
                name: "IX_routes_claims_claim_id",
                schema: "auth",
                table: "routes_claims",
                column: "claim_id");
